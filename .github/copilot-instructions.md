...
│   ├── src/
│   │   ├── modules/
│   │   │   ├── agents/              # Agent CRUD ve Management
│   │   │   ├── file-processing/     # Dosya işleme servisleri
│   │   │   ├── mail-analysis/       # Mail analiz engine
│   │   │   ├── llm-integration/     # LLM servis adaptörleri
│   │   │   ├── queue-manager/       # Task queue yönetimi
...
│   ├── src/
│   │   ├── components/
│   │   │   ├── agent-manager/       # Agent yönetim bileşenleri
...
3. API endpointleri test et: `curl http://localhost:2809/api/health`
4. Frontend test et: http://localhost:3009
5. Test agent dosyalarını kullanarak API'leri test et:
   - `test-agent.json` - Agent oluşturma testi
   - `test-mail.json` - Mail analiz testi
   - `test-queue-task.json` - Queue işlem testi
...
# Queue durumu  
curl http://localhost:2809/api/queue/stats
